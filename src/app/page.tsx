    ...
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(148,163,184,0.25),_transparent_60%),radial-gradient(circle_at_80%_20%,_rgba(59,130,246,0.18),_transparent_45%),radial-gradient(circle_at_20%_70%,_rgba(236,72,153,0.16),_transparent_45%),linear-gradient(135deg,_#f8fafc,_#eef2ff)]">
      ...
      <main className="relative max-w-7xl mx-auto px-6 pt-32 pb-20">
        <div className="text-center space-y-8 mb-20">
          <div className="inline-flex items-center gap-2 px-5 py-2 glass-panel rounded-full text-sm font-medium text-slate-700 mb-4">
          ...
          <h2 className="text-6xl md:text-7xl font-bold leading-tight">
            ...
            <br />
            <span className="text-slate-900">Master Your Focus.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            ...
            <Link
              href="#features"
              className="px-8 py-4 glass-panel rounded-2xl hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 text-lg font-semibold text-slate-700"
            >
              See How It Works
            </Link>
          </div>
        ...
        <div className="glass-panel glass-shimmer rounded-3xl p-12 mb-32 shadow-2xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-slate-900">
            <div>
            ...
            <div>
              ...
              <div className="text-slate-600">Study Hours Locked</div>
            </div>
            <div>
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">Three steps to distraction-free studying</p>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-white/40 glass-panel py-12 mt-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-semibold mb-3">Product</h3>
              <div className="space-y-2 text-sm text-slate-600">
                <div><a href="#" className="hover:text-slate-900 transition-colors">Features</a></div>
                <div><a href="#" className="hover:text-slate-900 transition-colors">Pricing</a></div>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-3">Company</h3>
              <div className="space-y-2 text-sm text-slate-600">
                <div><a href="#" className="hover:text-slate-900 transition-colors">About</a></div>
                <div><a href="#" className="hover:text-slate-900 transition-colors">Contact</a></div>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-3">Legal</h3>
              <div className="space-y-2 text-sm text-slate-600">
                <div><a href="#" className="hover:text-slate-900 transition-colors">Privacy</a></div>
                <div><a href="#" className="hover:text-slate-900 transition-colors">Terms</a></div>
              </div>
            </div>
            <div>
              <h3 className="font-semibold mb-3">Support</h3>
              <div className="space-y-2 text-sm text-slate-600">
                <div><a href="#" className="hover:text-slate-900 transition-colors">Help Center</a></div>
                <div><a href="#" className="hover:text-slate-900 transition-colors">Community</a></div>
              </div>
            </div>
          </div>
